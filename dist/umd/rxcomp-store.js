...
(function(g,f){typeof exports==='object'&&typeof module!=='undefined'?f(exports,require('rxcomp'),require('rxjs/operators'),require('rxjs'),require('immer')):typeof define==='function'&&define.amd?define(['exports','rxcomp','rxjs/operators','rxjs','immer'],f):(g=typeof globalThis!=='undefined'?globalThis:g||self,f((g.rxcomp=g.rxcomp||{},g.rxcomp.store={}),g.rxcomp,g.rxjs.operators,g.rxjs,g.immer));}(this,(function(exports, rxcomp, operators, rxjs, immer){'use strict';function _defineProperties(target, props) {
...
StorageService.supported = false;var CookieStorageService = /*#__PURE__*/function (_StorageService) {
...
CookieStorageService.items$ = new rxjs.ReplaySubject(1);var CookieStorageComponent = /*#__PURE__*/function (_Component) {
...
LocalStorageService.items$ = new rxjs.ReplaySubject(1);var LocalStorageComponent = /*#__PURE__*/function (_Component) {
...
SessionStorageService.items$ = new rxjs.ReplaySubject(1);var SessionStorageComponent = /*#__PURE__*/function (_Component) {
